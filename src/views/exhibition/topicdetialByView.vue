                ...
                <div class="detailLeft fl">
                    ...
                    <div class="exhibit_turn clear">
                        ...
                        <div class="down_exhit">
                            <a href="/webCollection/collectionDetail?resId=433aa508690945c692ad5a8e04936b75&amp;exId=a8dc5deffbe04cef90f27b6b975945ab">下一展品：骑豹的丘比特</a>
                        </div>
                    </div>
                </div>
...
.collection-btns .collection-voice-icons-b {
    background: url(../../assets/img/icons/voice-pause.png) no-repeat center center;
    background-size: 16px 24px;
}
