...
.exhi-atlas .picShow .swiper-slide {
...
.exhi-atlas .picShow .swiper-slide img {
    max-width: 800px;
    max-height: 600px;
}
...
.exhibitsPicsWrap .swiper-pagination {
    bottom: -10px !important;
}

.exhibitsPicsWrap .exhi-atlas-next,
.exhibitsPicsWrap .exhi-atlas-prev {
    width: 54px;
    height: 96px;
    position: absolute;
    top: 50%;
...
.exhibitsPicsWrap .exhi-atlas-prev {
    background: url(../../assets/img/icons/index-prev.png) no-repeat left center;
    left: 2px;
}

.exhibitsPicsWrap .exhi-atlas-next {
    background: url(../../assets/img/icons/index-next.png) no-repeat right center;
    right: 2px;
}

.exhibitsPicsWrap .exhi-atlas-prev:hover {
    background: url(../../assets/img/icons/index-prev-active.png) no-repeat left center;
    left: 2px;
}

.exhibitsPicsWrap .exhi-atlas-next:hover {
    background: url(../../assets/img/icons/index-next-active.png) no-repeat right center;
    right: 2px;
}
