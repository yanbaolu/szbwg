        ...
        <div class="news_main" style="margin-bottom:40px;">
            <div class="navPath_new clear" style="margin-bottom:33px;">
                <div class="navPath clear">
                    ...
                    <p class="clear"><i></i><a href="javascript:;">申报指南</a><i></i></p>
                </div>
            </div>
            <div class="news_message">
                <div class="intang_title">
                    <h3 class="clearfix">
                        <a href="#" target="_blank" class="title_a">国家级申报指南</a>
                        <router-link target="_blank" :to="{name:'intangibleLRList',query:{type:1,title:'国家级申报指南',iSf:false}}" class="more">查看更多</router-link>
                    </h3>
                </div>
                ...
                <div class="intang_title">
                    <h3 class="clearfix">
                        <a href="#" target="_blank" class="title_a">省级申报指南</a>
                        <router-link target="_blank" :to="{name:'intangibleLRList',query:{type:2,title:'省级申报指南',iSf:false}}" class="more">查看更多</router-link>
                    </h3>
                </div>
                <div class="news_content laws_content">
                ...
                <div class="intang_title">
                    <h3 class="clearfix">
                        <a href="#" target="_blank" class="title_a">市级申报指南</a>
                       <router-link target="_blank" :to="{name:'intangibleLRList',query:{type:3,title:'市级申报指南',iSf:false}}" class="more">查看更多</router-link>
                    </h3>
                </div>
                <div class="news_content laws_content">
...
export default {
    ...
    methods: {
        getLawerC(){
            ...
            API.get2('intangible/guide/page/L0408',data).then(res=>{
                if (res.code==0) {
