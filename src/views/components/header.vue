                ...
                <div class="comWidth hearderWrap">
                    ...
                    <nav class="navBar">
                        <ul class="nav-first">
                            ...
                            <li>
                                <router-link :to="{path:'exhibition'}">展馆</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'exhlist'}">展览</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'collection'}">典藏</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'intangible'}">非遗</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'activity'}">活动</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'socialisation'}" class="social_c">社教</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'webPublication'}" class="acade_c">学术</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'publicationshop'}" class="creative_c">文创</router-link>
                            </li>
                            <li>
                                <router-link :to="{path:'aboutus'}" class="aboutus_c">深博</router-link>
                            </li>
                        </ul>
                        <ol class="nav-sec">
...
<<<<<<< HEAD
                    ...
                    <div class="infos">
                        <div class="personal-center item">
                            ...
                            <ul class="no-login " v-show="isLogoin">
                                <li class="" style="height:30px">
                                    <router-link :to="{path:'/'}" v-if="UserInfo">{{UserInfo.username}}</router-link>
                                </li>
                                <li style="height:30px">
                                    <router-link :to="{path:'collectExhibit'}">我的收藏</router-link>
                                </li>
                                <li style="height:30px">
                                    <router-link :to="{path:'reservation'}">我的预约</router-link>
                                </li>
                                <li style="height:30px">
                                    <router-link :to="{path:'modifypassword'}">修改密码</router-link>
                                </li>
...
export default {
    ...
    data() {
        return {
            ...
            onoff: true,
            isLogoin:this.$store.getters.isLogo,
            UserInfo:this.$store.getters.UserInfo
        }
    },
    mounted() {
        if(typeof(this.$store.getters.UserInfo)=='string'){
            console.log(this.UserInfo,787878787)
            this.UserInfo=JSON.parse(this.$store.getters.UserInfo)
        }else {
            this.UserInfo=this.$store.getters.UserInfo;
            console.log(this.UserInfo,5555555)
        }
        console.log(this.$store.getters.UserInfo,localStorage.getItem('UserInfo'))
